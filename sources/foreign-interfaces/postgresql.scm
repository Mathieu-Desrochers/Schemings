...
(define postgresql-type-int8 (foreign-value "INT8OID" int))
(define postgresql-type-numeric (foreign-value "NUMERICOID" int))
(define postgresql-type-float4 (foreign-value "FLOAT4OID" int))
(define postgresql-type-float8 (foreign-value "FLOAT8OID" int))
(define postgresql-type-varchar (foreign-value "VARCHAROID" int))
